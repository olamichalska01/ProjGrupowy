...
namespace ComUnity.Application.Migrations
{
    ...
    [Migration("20230601203818_migracjaaaaklj")]
    partial class migracjaaaaklj
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventCategoryUserProfile", b =>
                {
                    b.Property<Guid>("FavoriteCategoriesEventCategoryId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("UsersUserId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FavoriteCategoriesEventCategoryId", "UsersUserId");
            ...
            modelBuilder.Entity("EventCategoryUserProfile", b =>
                {
                    b.HasOne("ComUnity.Application.Features.ManagingEvents.Entities.EventCategory", null)
                        .WithMany()
                        .HasForeignKey("FavoriteCategoriesEventCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
